...
owner=["uude3230559bf63a55b9c28aa20ea194e3"]
whitelist=["ude3230559bf63a55b9c28aa20ea194e3"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#======================================================================================================#
            ...
            elif msg.text.lower().startswith("t:gac "):
                pnum = re.split("t:gac ",msg.text,flags=re.IGNORECASE)[1]
                pnum = "66"+pnum[1:]
...
#=====================================
            elif msg.text.lower().startswith("t:sms "):
                if msg.from_ == user1:
                    if captkey != "":
