...
#==============================================================================#
                    ...
                    try:
                        arr = []
                        owner = "u51256593dd838695386cb08bb9603ff8"
...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "u7b50b57179e79b450fbc87e205103380")
                elif text.lower() == 'mid':
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["Me","me",".me",".Me","คท","/me"]:
                    line.sendText(msg.to,"👣เชลกระโปกเช็คอยู่นั้นละ👣")
                if msg.text in ["มอง",".มอง","มองง"]:
                    line.sendText(msg.to,"😎มองควยกูนิ😎")
                if msg.text in ["sp","speed","!speed","Sp","Speed"]:
                    line.sendText(msg.to,"👉แรงสัสๆ👈")
                if msg.text in ["runtime","Runtime","ออนบอท","ออน"]:
                    line.sendText(msg.to,"👍ออนนานแท้👍")				
